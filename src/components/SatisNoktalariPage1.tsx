...
import { MapPin, ArrowRight, ChevronRight, Building, Phone, Mail } from 'lucide-react';
...
export const SatisNoktalariPage: React.FC<SatisNoktalariPageProps> = ({ onOpenContact }) => {
    ...
    fetch('/Turkiye-haritasi.svg')
      ...
      .then((data) => {
        ...
        if (svgStartIdx !== -1) {
          ...
          // We construct custom pin SVG elements positioned exactly at the center coordinates
          // calculated by tracing the vector paths in the viewBox: (1007.478 x 527.323)
          ...
          const pinsMarkup = `
            <g id="map-interactive-pins">
              ...
              <!-- Antalya Pin -->
              <g transform="translate(257.501, 375.469)" class="map-svg-pin" data-id="antalya">
                <circle cx="0" cy="0" r="14" fill="rgba(255, 116, 23, 0.25)" class="ping-circle" />
                <circle cx="0" cy="0" r="6" fill="#FF7417" stroke="#FFFFFF" stroke-width="2" />
  ...
  const reps: Representative[] = [
    {
      ...
      phone: '0543 350 7587',
      email: 'antalya@nctrobotic.com',
      details: 'Başer Bilişim Teknolojileri, Akdeniz Bölge Temsilcisi olarak Antalya ve çevre illerde NCT Robotik eğitim robotlarımızın tedarik, kurulum ve yerel destek süreçlerini yürütmektedir.'
    },
    {
      id: 'sakarya',
      city: 'Sakarya',
      ...
      phone: '0543 350 7587',
      email: 'sakarya@nctrobotic.com',
      details: 'East To West Yabancı Dil Kursu, Doğu Marmara Bölge Temsilcisi olarak Sakarya ve çevre illerde Orbit ailesi robotik setlerimizin dağıtımını ve eğitim uygulamalarını gerçekleştirmektedir.'
    },
    {
      id: 'bursa',
      city: 'Bursa',
      ...
      phone: '0543 350 7587',
      email: 'bursa@nctrobotic.com',
      coverage: 'Bursa ve Çevre İller',
      details: 'Gülşah Kılınç, Güney Marmara Bölge Temsilcisi olarak Bursa ve çevre illerdeki okullar, eğitim kurumları ve velilerimiz için bölgesel danışmanlık ve satış hizmeti sunmaktadır.'
    }
  ];
  ...
  const handleMapClick = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    const pinGroup = target.closest('.map-svg-pin') || target.closest('g[id]');
    if (pinGroup) {
  ...
  return (
    <div className="bg-white text-brand-primary min-h-screen font-sans selection:bg-brand-accent selection:text-white">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .turkey-map path {
          fill: #E8F1F7 !important;
          stroke: #FFFFFF !important;
          stroke-width: 1.2 !important;
          transition: fill 0.25s ease;
        }
        .turkey-map g:hover path {
          fill: #DDEAF3 !important;
          cursor: pointer;
        }
        @keyframes svg-pulse {
          0% {
        ...
        /* Style adjustments when list/card highlights a rep city */
        ${activeRepId ? `
          .turkey-map #${activeRepId} path {
            fill: #DDEAF3 !important; /* Soft highlighted blue-gray (No Orange fill on paths) */
          }
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
            <div className="max-w-xl lg:max-w-2xl space-y-6 text-left">
              ...
              <p className="font-manrope text-slate-600 text-base sm:text-lg leading-relaxed font-normal max-w-xl">
                Orbit ailesi ürünlerine, Türkiye'nin farklı şehirlerindeki bölge temsilcilerimiz aracılığıyla ulaşabilirsiniz. Size en yakın temsilcimizi seçerek ürünlerimiz hakkında detaylı bilgi alabilir ve satın alma sürecinizi kolayca başlatabilirsiniz.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12 sm:mb-16">
            ...
            <p className="font-manrope text-slate-500 text-base">
              Aşağıdaki haritadan veya listeden size en yakın bölge temsilcimizi bulabilirsiniz.
            </p>
          </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      {/* Orange Pin Icon */}
                      <div className={`mt-1 flex-shrink-0 transition-transform duration-200 ${
                    ...
                    <div className="p-6 sm:p-8 space-y-4">
                      ...
                      <div className="pt-4 border-t border-slate-100 space-y-2.5">
                        ...
                        <div className="flex items-center gap-3 text-slate-600 text-xs">
                          ...
                          <a href={`tel:${rep.phone.replace(/\s+/g, '')}`} className="hover:text-brand-accent transition-colors font-medium">
                            {rep.phone}
                          </a>
                        </div>
                        <div className="flex items-center gap-3 text-slate-600 text-xs">
                          <Mail className="w-4 h-4 text-slate-400 shrink-0" />
                          <a href={`mailto:${rep.email}`} className="hover:text-brand-accent transition-colors font-medium">
                            {rep.email}
                          </a>
                        </div>
                      </div>
